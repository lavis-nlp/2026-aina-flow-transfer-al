...
OUTPUT_DIR_TEMPLATE = "paper/{label_type}/tae-cluster/ex={experiment_name}/target={target}/source={source}/query={query_strategy}/label={label_selection}/weighting={weighting_strategy}/seed={seed}"
                ...
                for ls in tqdm(LABEL_SELECTION_STRATEGIES, desc="Label Selection Strategies", unit="strategy"):
                    for ws in tqdm(WEIGHTING_STRATEGIES, desc="Weighting Strategies", unit="strategy"):
                        ...
                        run_experiment(
                            ...
                            test_X=test_X.copy(),
                            test_y=test_y.copy(),
                            cluster2ids=cluster2ids.copy(),
                            id2cluster=id2cluster.copy(),
                            seed=seed,
